...
class InteriorDesignItems extends StatefulWidget {
  @override
  _interiorDesignItemsState createState() => _interiorDesignItemsState();
}

class _interiorDesignItemsState extends State<InteriorDesignItems> {
